cask 'mactex' do
  ...
  url "http://mirror.ctan.org/systems/mac/mactex/mactex-#{version.delete(',')}.pkg"
  ...
  uninstall pkgutil: [
                       "org.tug.mactex.gui#{version.before_comma}",
                       "org.tug.mactex.texlive#{version.before_comma}",
                     ],
            delete:  [
                       "/usr/local/texlive/#{version.before_comma}",
                       '/Applications/TeX',
  ...
  zap trash: [
               ...
               "~/Library/texlive/#{version.before_comma}",
               # TexShop:
